...
const initialRequests = [
  { id: 1, mentee: "홍길동", date: "2024-03-15", time: "14:00", type: "화상 멘토링" },
  { id: 2, mentee: "김철수", date: "2024-03-16", time: "10:00", type: "이력서 첨삭" },
  // ... 더 많은 요청 데이터
];
            ...
            <CardContent>
              ...
              {request.type === "화상 멘토링" && (
                <div className="mt-4">
                  ...
                  <Button onClick={() => handleShareLink(request.id)} variant="outline" size="sm">
                    링크 공유
                  </Button>
                </div>
              )}
